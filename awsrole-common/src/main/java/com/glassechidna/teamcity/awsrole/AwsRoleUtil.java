...
public class AwsRoleUtil {
    ...
    public static String getExternalId(Map<String, String> params) {
        String buildTypeId = params.get("system.teamcity.buildType.id");
        String externalId = params.getOrDefault(AwsRoleConstants.EXTERNAL_ID_PARAMETER, "");
    ...
    public static String getSessionName(Map<String, String> params) {
        String buildTypeId = params.get("system.teamcity.buildType.id");
        String buildNumber = params.get("system.build.number");
